  ...
  <el-dialog v-model="visible" title="积分操作" width="80%" top="5vh" :close-on-click-modal="false" class="score-dialog">
    <div class="score-dialog-header">
      <el-form-item label="选择周次">
        <el-select v-model="week" placeholder="选择周次" style="width: 120px" @change="onWeekChange">
          ...
          <template #title>
            <div class="group-title">
              ...
              <div class="group-batch-buttons" @click.stop>
                <el-select v-model="batchReasonId" placeholder="选择加减分" size="small" style="width: 160px">
...
<style scoped>
.score-dialog :deep(.el-dialog__body) { padding: 20px; max-height: 70vh; overflow-y: auto; }
.group-title { display: flex; justify-content: space-between; align-items: center; width: 100%; padding-right: 20px; }
.group-batch-buttons { display: flex; gap: 8px; }
</style>